...
static bool encoder_read_next_frame(encoder *e) {
    ...
    case gmsk_encoding:
        ...
        break;
    case fsk_encoding:
        fskframegen_assemble(e->frame.fsk.framegen, header, e->readframe,
                             framelen);
        e->frame.fsk.symbols_remaining = 
            fskframegen_getframelen(e->frame.fsk.framegen);
        break;
    }
...
static size_t encoder_fillsymbols(encoder *e, size_t requested_length) {
    ...
    case fsk_encoding:
        ...
        fskframegen_write_samples(e->frame.fsk.framegen, e->symbolbuf,
                                  requested_length);
